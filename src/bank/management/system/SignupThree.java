...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        cardDetail.setBounds(100, 310, 250, 20);
        add(cardDetail);
        ...
        pnumber.setBounds(330, 340, 250, 30);
        add(pnumber);
        
        JLabel pinDetail = new JLabel("Your 4-Digits Pin");
        pinDetail.setFont(new Font("Raleway", Font.BOLD, 12));
        pinDetail.setBounds(100, 370, 250, 20);
        add(pinDetail);
        ...
        if (ae.getSource() == submit){
            ...
            try {
                if (accountType.equals("")){
                    ...
                    // You can't open an account with Rs 0 so, you need add some money;
                    setVisible(false);
